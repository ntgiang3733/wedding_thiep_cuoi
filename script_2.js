...
!function () {
    ...
    function p(t, n, i) {
        return (p = Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? e : o).apply(null, arguments)
    }
        ...
        W.prototype.start = function () {
            var o = this.c.m.document
                ...
                , t = new Promise(function (i, e) {
                    !function n() {
                        var t;
                        r() - s >= a.f ? e() : o.fonts.load(_(t = a.a) + " " + t.f + "00 300px " + j(t.c), a.h).then(function (t) {
    ...
    function B() {
        var t;
        return null === P && (t = /AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),
            P = !!t && (parseInt(t[1], 10) < 536 || 536 === parseInt(t[1], 10) && parseInt(t[2], 10) <= 11)),
            P
    }
    function O(t, n, i) {
        for (var e in I)
    ...
    function L(t) {
        ...
        (n = i === t.f.serif && e === t.f["sans-serif"]) || (n = B() && O(t, i, e)),
            n ? r() - t.A >= t.w ? B() && O(t, i, e) && (null === t.u || t.u.hasOwnProperty(t.a.c)) ? D(t, t.v) : D(t, t.B) : setTimeout(p(function () {
                L(this)
            }, t), 50) : D(t, t.v)
    }
    function D(t, n) {
    ...
    var q = null;
    function H(t) {
        0 == --t.f && t.j && (t.o ? ((t = t.a).g && d(t.f, [t.a.c("wf", "active")], [t.a.c("wf", "loading"), t.a.c("wf", "inactive")]),
            S(t, "active")) : T(t.a))
    }
    function t(t) {
        this.j = t,
    ...
    $.prototype.g = function (t) {
        ...
        $.prototype.h = function (t) {
            var n, i, e, o = this.a;
            o.g && (n = a(o.f, o.a.c("wf", t.c, x(t).toString(), "active")),
                i = [],
                                    ...
                                    if (0 === h.length && u)
                                        ...
                                        for (var i = [], e = 0; e < h.length; e++) {
                                            ...
                                            s.g && d(s.f, [s.a.c("wf", r.c, x(r).toString(), "loading")]),
                                                S(s, "fontloading", r),
                                                (s = null) === q && (q = !!window.FontFace && (!(r = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent)) || 42 < parseInt(r[1], 10))),
                                                s = q ? new W(p(c.g, c), p(c.h, c), c.c, o, c.s, a) : new F(p(c.g, c), p(c.h, c), c.c, o, c.s, t, a),
                                                i.push(s)
                                        }
        ...
        M.prototype.load = function (s) {
            var r, t, n, i = this, c = i.a.projectId, e = i.a.version;
            c ? (r = i.c.m,
                g(this.c, (t = c,
                    n = e,
                    l((e = i).c) + "//" + (e = (e.a.api || "fast.fonts.net/jsapi").replace(/^.*http(s?):(\/\/)?/, "")) + "/" + t + ".js" + (n ? "?v=" + n : "")), function (t) {
                        t ? s([]) : (r["__MonotypeConfiguration__" + c] = function () {
                            return i.a
                        }
                            ,
                            function t() {
                                if (r["__mti_fntLst" + c]) {
                                    var n, i = r["__mti_fntLst" + c](), e = [];
                                    if (i)
                                        for (var o = 0; o < i.length; o++) {
                                            var a = i[o].fontfamily;
                                            null != i[o].fontStyle && null != i[o].fontWeight ? (n = i[o].fontStyle + i[o].fontWeight,
                    ...
                    }).id = "__MonotypeAPIScript__" + c) : s([])
        }
        ,
        z.prototype.load = function (t) {
            for (var n = this.a.urls || [], i = this.a.families || [], e = this.a.testStrings || {}, o = new v, a = 0, s = n.length; a < s; a++)
                u(this.c, n[a], m(o));
            var r = [];
            for (a = 0,
                s = i.length; a < s; a++)
                ...
                if (2 <= e.length) {
                    ...
                    if (c)
                        for (var f = (c = c.split(",")).length, l = 0; l < f; l++)
                            (r = !(r = c[l]).match(/^[\w-]+$/) || null == (s = Q.exec(r.toLowerCase())) ? "" : [r = null == (r = s[2]) || "" == r ? "n" : J[r], s = null == (s = s[1]) || "" == s ? "4" : U[s] || (isNaN(s) ? "4" : s.substr(0, 1))].join("")) && h.push(r);
                    0 < h.length && (a = h),
                        3 == e.length && (h = [],
                            0 < (e = (e = e[2]) ? e.split(",") : h).length && (e = R[e[0]]) && (t.c[o] = e))
                }
                for (t.c[o] || (e = R[o]) && (t.c[o] = e),
                    e = 0; e < a.length; e += 1)
            ...
            t ? (n.__webfontfontdeckmodule__ || (n.__webfontfontdeckmodule__ = {}),
                n.__webfontfontdeckmodule__[t] = function (t, n) {
                    for (var i, e, o, a = 0, s = n.fonts.length; a < s; ++a) {
                        var r = n.fonts[a];
                        h.a.push(new b(r.name, (i = "font-weight:" + r.weight + ";font-style:" + r.style,
                            r = o = e = void 0,
                            e = 4,
                            o = "n",
                            r = null,
                            i && ((r = i.match(/(normal|oblique|italic)/i)) && r[1] && (o = r[1].substr(0, 1).toLowerCase()),
                                (r = i.match(/([1-9]00|normal|bold)/i)) && r[1] && (/bold/i.test(r[1]) ? e = 7 : /[1-9]00/.test(r[1]) && (e = parseInt(r[1].substr(0, 1), 10)))),
                            o + e)))
                    }
                    c(h.a)
                }
                ,
                g(this.c, l(this.c) + (this.f.api || "//f.fontdeck.com/s/css/js/") + ((n = this.c).m.location.hostname || n.a.location.hostname) + "/" + t + ".js", function (t) {
                    t && c([])
                })) : c([])
        }
        ;
 ...
 */
!function (t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("canvasTxt", [], e) : "object" == typeof exports ? exports.canvasTxt = e() : t.canvasTxt = e()
            ...
            return function (t) {
                ...
                if (t) {
                    ...
                    return "Object" === n && t.constructor && (n = t.constructor.name),
                        "Map" === n || "Set" === n ? Array.from(n) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? i(t, e) : void 0
                }
            }(t, e) || function () {
            ...
            drawText: function (t, e, n, i, o, a) {
                ...
                if (n = f[0],
                    ...
                    var c = this.fontStyle
                        ...
                        , p = this.fontSize
                        , y = this.font
                        , b = "".concat(c, " ").concat(h, " ").concat(d, " ").concat(p, "px ").concat(y);
                    t.font = b;
                    var g, v = i + a / 2 + parseInt(this.fontSize) / 2;
                    "right" === this.align ? (g = s,
                        t.textAlign = "right") : "left" === this.align ? (g = n,
                            t.textAlign = "left") : (g = n + o / 2,
                                t.textAlign = "center");
                    var m = []
                        , x = e.split("\n")
                    ...
                    var T = this.lineHeight ? this.lineHeight : this.getTextHeight(t, e, b)
                        , j = T * (m.length - 1)
                        , A = i;
                    return "top" === this.vAlign ? v = i + this.fontSize : "bottom" === this.vAlign ? (v = l - j,
                        A = l) : (A = i + a / 2,
                            v -= j / 2),
...
window.addEventListener('load', function () {
    ...
    //         $(".message-error").show().find('span').html("Vui lòng xác nhận thông tin trên.");
    ...
    //     $('.row-guest-questions').find('.form-control').each(function (index, element) {
    ...
    //             if (res.error) {
    //                 $(".message-error").show().find('span').html(res.message);
    //                 $(".message-success").hide();
    //                 $("#attendance_status_id").removeClass('boder-danger');
    //                 $("#plus_ones_id").removeClass('boder-danger');
    //             } else {
    //                 $(".message-success").show().find('span').html(res.message);
    //                 $(".message-error").hide();
    //             }
    //         },
    //         complete: function () {
    //             _this.find('button[type="submit"]').removeAttr('disabled').find('.spinner-grow').remove();
    //         }
    //     });
    // });

    // const plusOnesID = document.getElementById("plus_ones_id");
    // document.getElementById("attendance_status_id").addEventListener("change", (event) => {
    ...
    //     $('.row-guest-questions').find('.form-control').each(function (index) {
    //         index += 1;
    //         let id = 'guest_question_index_' + index;
    //         let $element = $('#' + id);
    //         if (!status) {
